...
contract StarNotary is ERC721 {
    ...
    // Adding name and symbol properties
    string public name = "Star Wars";
    string public symbol = "STWRS";
    ...
    // Creating Star using the Struct; Passing the name and tokenId as a parameters
    ...
    // Function allowing a conversion of an address into a payable address
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        //1. returning the Star saved in tokenIdToStarInfo mapping
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        //2. Getting the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId2)

        address firstOwner = ownerOf(_tokenId1);
        address secondOwner = ownerOf(_tokenId2);
        
        require(firstOwner == msg.sender || secondOwner == msg.sender, "Invalid");
